...
5. Select the code that would show the countries 

	with a greater GDP than any country in Africa (some countries may have NULL gdp values). 
...
1. Select the code which uses an outer join correctly.
 ...
 3. Select out of following the code 
 hich uses a JOIN to show a list of all the departments and number of employed teachers
